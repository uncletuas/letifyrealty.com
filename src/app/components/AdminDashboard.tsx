...
export function AdminDashboard({ onClose, accessToken, children }: AdminDashboardProps) {
  ...
  const fetchContactInquiries = async () => {
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-ef402f1d/contact/all`,
  ...
  const fetchPropertyInquiries = async () => {
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-ef402f1d/property-inquiries/all`,
        { headers: { Authorization: `Bearer ${accessToken}` } }
      );
      const data = await response.json();
      if (response.ok && data.inquiries) {
  ...
  const fetchServiceRequests = async () => {
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-ef402f1d/requests/all`,
        { headers: { Authorization: `Bearer ${accessToken}` } }
      );
      const data = await response.json();
  ...
  const fetchMessages = async () => {
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-ef402f1d/admin/messages`,
        { headers: { Authorization: `Bearer ${accessToken}` } }
      );
      const data = await response.json();
  ...
  const fetchNotifications = async () => {
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-ef402f1d/admin/notifications`,
        { headers: { Authorization: `Bearer ${accessToken}` } }
      );
      const data = await response.json();
  ...
  const fetchMailingLists = async () => {
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-ef402f1d/admin/mailing-lists`,
        { headers: { Authorization: `Bearer ${accessToken}` } }
      );
      const data = await response.json();
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-ef402f1d/admin/users`,
        { headers: { Authorization: `Bearer ${accessToken}` } }
      );
      const data = await response.json();
  ...
  const handleSendMailing = async () => {
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-ef402f1d/admin/mailing-lists/${mailingSend.listId}/send`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
